...
export default function ResultadoLotofacilHoje() {
  ...
  const schema = {
    ...
    "@type": "WebPage",
    name: `Resultado da Lotofácil Hoje — Valtor`,
    description: `Confira o último resultado da Lotofácil. Números sorteados, prêmios e ganhadores atualizados.`,
    url: "https://www.valtor.com.br/resultado-lotofacil-hoje",
  ...
  return (
    <div className="min-h-screen bg-[#f0f4f8]">
      <SEO
        title="Resultado da Lotofácil Hoje — Último Concurso"
        description="Confira o resultado mais recente da Lotofácil com números sorteados, prêmios e ganhadores. Atualizado após cada sorteio."
        path="/resultado-lotofacil-hoje"
        schema={schema}
      />
      <Navbar />
      ...
      >
        <div className="container">
          ...
          <h1 className="text-2xl md:text-3xl font-black">Resultado da Lotofácil hoje</h1>
          <p className="text-white/70 mt-1">
            Confira os números sorteados no último concurso da Lotofácil
          </p>
        </div>
      </div>
      ...
      <div className="container py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-5">
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-5 shadow-sm">
                <h3 className="font-bold text-[#0d1b3e] text-sm mb-3">Análises da Lotofácil</h3>
                <div className="space-y-2">
                  <Link href="/numeros-mais-sorteados-lotofacil">
                    <Button variant="outline" size="sm" className="w-full justify-start gap-2 text-xs">
                      <TrendingUp className="w-4 h-4" style={{ color }} />
                      Números mais sorteados
                    </Button>
                  </Link>
                  <Link href="/numeros-atrasados-lotofacil">
                    <Button variant="outline" size="sm" className="w-full justify-start gap-2 text-xs">
                      <TrendingDown className="w-4 h-4" style={{ color }} />
                      Números atrasados
                    </Button>
                  </Link>
                  <Link href="/frequencia-lotofacil">
                    <Button variant="outline" size="sm" className="w-full justify-start gap-2 text-xs">
                      <BarChart3 className="w-4 h-4" style={{ color }} />
                      Frequência completa
                    </Button>
                  </Link>
                  <Link href="/gerador?loteria=lotofacil">
                    <Button size="sm" className="w-full justify-start gap-2 text-xs bg-[#0d1b3e] hover:bg-[#162a5c] text-white">
                      <Zap className="w-4 h-4" />
                      Gerar jogo da Lotofácil
                    </Button>
                  </Link>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-5 shadow-sm">
                ...
                <p className="text-sm text-gray-600">
                  A Lotofácil é sorteada de segunda a sábado, às 21h. Os resultados são atualizados automaticamente após cada sorteio.
                </p>
              </div>
        ...
        <div className="mt-8 bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="font-medium text-[#0d1b3e] text-sm">Que horas sai o resultado da Lotofácil?</h3>
              <p className="text-sm text-gray-600 mt-1">O sorteio da Lotofácil acontece de segunda a sábado, às 21h (horário de Brasília). Os resultados são publicados minutos após o sorteio.</p>
            </div>
            <div>
              <h3 className="font-medium text-[#0d1b3e] text-sm">Quantos números são sorteados na Lotofácil?</h3>
              <p className="text-sm text-gray-600 mt-1">São sorteados 15 números de um total de 25 (01 a 25). O apostador marca entre 15 e 20 números no volante.</p>
            </div>
            <div>
              <h3 className="font-medium text-[#0d1b3e] text-sm">Quanto custa apostar na Lotofácil?</h3>
              <p className="text-sm text-gray-600 mt-1">A aposta mínima (15 números) custa R$ 3,00. Quanto mais números marcar, maior o valor da aposta e as chances de ganhar.</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-wrap gap-2">
            <Link href="/numeros-mais-sorteados-lotofacil">
              <Button variant="outline" size="sm" className="text-xs gap-1.5 hover:bg-gray-50">
                <ArrowRight className="w-3 h-3" /> Números mais sorteados da Lotofácil
              </Button>
            </Link>
            <Link href="/numeros-atrasados-lotofacil">
              <Button variant="outline" size="sm" className="text-xs gap-1.5 hover:bg-gray-50">
                <ArrowRight className="w-3 h-3" /> Números atrasados da Lotofácil
              </Button>
            </Link>
            <Link href="/gerador?loteria=lotofacil">
              <Button variant="outline" size="sm" className="text-xs gap-1.5 hover:bg-gray-50">
                <ArrowRight className="w-3 h-3" /> Gerador da Lotofácil
              </Button>
            </Link>
          </div>
        </div>
