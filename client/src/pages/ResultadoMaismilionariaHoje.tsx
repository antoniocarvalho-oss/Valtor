...
export default function ResultadoMaismilionariaHoje() {
  const slug = "maismilionaria";
  ...
  const schema = {
    ...
    "@type": "WebPage",
    name: `Resultado da +Milionária Hoje — Valtor`,
    description: `Confira o último resultado da +Milionária. Números sorteados, prêmios e ganhadores atualizados.`,
    url: "https://www.valtor.com.br/resultado-maismilionaria-hoje",
  ...
  return (
    <div className="min-h-screen bg-[#f0f4f8]">
      <SEO
        title="Resultado da +Milionária Hoje — Último Concurso"
        description="Confira o resultado mais recente da +Milionária com números sorteados, prêmios e ganhadores. Atualizado após cada sorteio."
        path="/resultado-maismilionaria-hoje"
        schema={schema}
      />
      <Navbar />
      ...
      >
        <div className="container">
          ...
          <h1 className="text-2xl md:text-3xl font-black">Resultado da +Milionária hoje</h1>
          <p className="text-white/70 mt-1">
            Confira os números sorteados no último concurso da +Milionária
          </p>
        </div>
      </div>
      ...
      <div className="container py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-5">
              <div className="bg-white rounded-2xl border border-gray-200 p-5 shadow-sm">
                <h3 className="font-bold text-[#0d1b3e] text-sm mb-3">Análises da +Milionária</h3>
                <div className="space-y-2">
                  <Link href="/numeros-mais-sorteados-maismilionaria">
                    <Button variant="outline" size="sm" className="w-full justify-start gap-2 text-xs">
                      <TrendingUp className="w-4 h-4" style={{ color }} />
                      Números mais sorteados
                    </Button>
                  </Link>
                  <Link href="/numeros-atrasados-maismilionaria">
                    <Button variant="outline" size="sm" className="w-full justify-start gap-2 text-xs">
                      <TrendingDown className="w-4 h-4" style={{ color }} />
                      Números atrasados
                    </Button>
                  </Link>
                  <Link href="/frequencia-maismilionaria">
                    <Button variant="outline" size="sm" className="w-full justify-start gap-2 text-xs">
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-5 shadow-sm">
                ...
                <p className="text-sm text-gray-600">
                  A +Milionária é sorteada sábados, às 20h. Os resultados são atualizados automaticamente após cada sorteio.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-5 shadow-sm">
                ...
                <Link href={`/${slug}`}>
                  <Button variant="outline" size="sm" className="w-full text-xs gap-1.5">
                    <ArrowRight className="w-3 h-3" />
                    Ver todos os concursos da +Milionária
                  </Button>
                </Link>
              </div>
            </div>
        ...
        <div className="mt-8 bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="font-medium text-[#0d1b3e] text-sm">Que horas sai o resultado da +Milionária?</h3>
              <p className="text-sm text-gray-600 mt-1">O sorteio da +Milionária acontece sábados, às 20h. Os resultados são publicados minutos após o sorteio.</p>
            </div>
            <div>
              <h3 className="font-medium text-[#0d1b3e] text-sm">Quantos números são sorteados na +Milionária?</h3>
              <p className="text-sm text-gray-600 mt-1">São sorteados 6 números de um total de 01 a 50 + 1 a 6 (trevos).</p>
            </div>
            <div>
              <h3 className="font-medium text-[#0d1b3e] text-sm">Quanto custa apostar na +Milionária?</h3>
              <p className="text-sm text-gray-600 mt-1">A aposta mínima custa R$ 6,00. Quanto mais números marcar, maior o valor da aposta e as chances de ganhar.</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-wrap gap-2">
            <Link href="/numeros-mais-sorteados-maismilionaria">
              <Button variant="outline" size="sm" className="text-xs gap-1.5 hover:bg-gray-50">
                <ArrowRight className="w-3 h-3" /> Números mais sorteados da +Milionária
              </Button>
            </Link>
            <Link href="/numeros-atrasados-maismilionaria">
              <Button variant="outline" size="sm" className="text-xs gap-1.5 hover:bg-gray-50">
                <ArrowRight className="w-3 h-3" /> Números atrasados da +Milionária
              </Button>
            </Link>
            <Link href={`/gerador?loteria=${slug}`}>
              <Button variant="outline" size="sm" className="text-xs gap-1.5 hover:bg-gray-50">
                <ArrowRight className="w-3 h-3" /> Gerador da +Milionária
              </Button>
            </Link>
          </div>
        </div>
