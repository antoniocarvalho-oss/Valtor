...
export default function ResultadoSuperseteHoje() {
  const slug = "supersete";
  ...
  const schema = {
    ...
    "@type": "WebPage",
    name: `Resultado da Super Sete Hoje — Valtor`,
    description: `Confira o último resultado da Super Sete. Números sorteados, prêmios e ganhadores atualizados.`,
    url: "https://www.valtor.com.br/resultado-supersete-hoje",
  ...
  return (
    <div className="min-h-screen bg-[#f0f4f8]">
      <SEO
        title="Resultado da Super Sete Hoje — Último Concurso"
        description="Confira o resultado mais recente da Super Sete com números sorteados, prêmios e ganhadores. Atualizado após cada sorteio."
        path="/resultado-supersete-hoje"
        schema={schema}
      />
      <Navbar />
      ...
      >
        <div className="container">
          ...
          <h1 className="text-2xl md:text-3xl font-black">Resultado da Super Sete hoje</h1>
          <p className="text-white/70 mt-1">
            Confira os números sorteados no último concurso da Super Sete
          </p>
        </div>
      </div>
      ...
      <div className="container py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-5">
              <div className="bg-white rounded-2xl border border-gray-200 p-5 shadow-sm">
                <h3 className="font-bold text-[#0d1b3e] text-sm mb-3">Análises da Super Sete</h3>
                <div className="space-y-2">
                  <Link href="/numeros-mais-sorteados-supersete">
                    <Button variant="outline" size="sm" className="w-full justify-start gap-2 text-xs">
                      <TrendingUp className="w-4 h-4" style={{ color }} />
                      Números mais sorteados
                    </Button>
                  </Link>
                  <Link href="/numeros-atrasados-supersete">
                    <Button variant="outline" size="sm" className="w-full justify-start gap-2 text-xs">
                      <TrendingDown className="w-4 h-4" style={{ color }} />
                      Números atrasados
                    </Button>
                  </Link>
                  <Link href="/frequencia-supersete">
                    <Button variant="outline" size="sm" className="w-full justify-start gap-2 text-xs">
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-5 shadow-sm">
                ...
                <p className="text-sm text-gray-600">
                  A Super Sete é sorteada segundas, quartas e sextas, às 15h. Os resultados são atualizados automaticamente após cada sorteio.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-5 shadow-sm">
                ...
                <Link href={`/${slug}`}>
                  <Button variant="outline" size="sm" className="w-full text-xs gap-1.5">
                    <ArrowRight className="w-3 h-3" />
                    Ver todos os concursos da Super Sete
                  </Button>
                </Link>
              </div>
            </div>
        ...
        <div className="mt-8 bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="font-medium text-[#0d1b3e] text-sm">Que horas sai o resultado da Super Sete?</h3>
              <p className="text-sm text-gray-600 mt-1">O sorteio da Super Sete acontece segundas, quartas e sextas, às 15h. Os resultados são publicados minutos após o sorteio.</p>
            </div>
            <div>
              <h3 className="font-medium text-[#0d1b3e] text-sm">Quantos números são sorteados na Super Sete?</h3>
              <p className="text-sm text-gray-600 mt-1">São sorteados 7 números de um total de 0 a 9 em 7 colunas.</p>
            </div>
            <div>
              <h3 className="font-medium text-[#0d1b3e] text-sm">Quanto custa apostar na Super Sete?</h3>
          ...
          <div className="flex flex-wrap gap-2">
            <Link href="/numeros-mais-sorteados-supersete">
              <Button variant="outline" size="sm" className="text-xs gap-1.5 hover:bg-gray-50">
                <ArrowRight className="w-3 h-3" /> Números mais sorteados da Super Sete
              </Button>
            </Link>
            <Link href="/numeros-atrasados-supersete">
              <Button variant="outline" size="sm" className="text-xs gap-1.5 hover:bg-gray-50">
                <ArrowRight className="w-3 h-3" /> Números atrasados da Super Sete
              </Button>
            </Link>
            <Link href={`/gerador?loteria=${slug}`}>
              <Button variant="outline" size="sm" className="text-xs gap-1.5 hover:bg-gray-50">
                <ArrowRight className="w-3 h-3" /> Gerador da Super Sete
              </Button>
            </Link>
          </div>
        </div>
