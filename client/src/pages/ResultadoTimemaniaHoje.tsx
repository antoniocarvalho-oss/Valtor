...
export default function ResultadoTimemaniaHoje() {
  const slug = "timemania";
  ...
  const schema = {
    ...
    "@type": "WebPage",
    name: `Resultado da Timemania Hoje — Valtor`,
    description: `Confira o último resultado da Timemania. Números sorteados, prêmios e ganhadores atualizados.`,
    url: "https://www.valtor.com.br/resultado-timemania-hoje",
  ...
  return (
    <div className="min-h-screen bg-[#f0f4f8]">
      <SEO
        title="Resultado da Timemania Hoje — Último Concurso"
        description="Confira o resultado mais recente da Timemania com números sorteados, prêmios e ganhadores. Atualizado após cada sorteio."
        path="/resultado-timemania-hoje"
        schema={schema}
      />
      <Navbar />
      ...
      >
        <div className="container">
          ...
          <h1 className="text-2xl md:text-3xl font-black">Resultado da Timemania hoje</h1>
          <p className="text-white/70 mt-1">
            Confira os números sorteados no último concurso da Timemania
          </p>
        </div>
      </div>
      ...
      <div className="container py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-5">
              <div className="bg-white rounded-2xl border border-gray-200 p-5 shadow-sm">
                <h3 className="font-bold text-[#0d1b3e] text-sm mb-3">Análises da Timemania</h3>
                <div className="space-y-2">
                  <Link href="/numeros-mais-sorteados-timemania">
                    <Button variant="outline" size="sm" className="w-full justify-start gap-2 text-xs">
                      <TrendingUp className="w-4 h-4" style={{ color }} />
                      Números mais sorteados
                    </Button>
                  </Link>
                  <Link href="/numeros-atrasados-timemania">
                    <Button variant="outline" size="sm" className="w-full justify-start gap-2 text-xs">
                      <TrendingDown className="w-4 h-4" style={{ color }} />
                      Números atrasados
                    </Button>
                  </Link>
                  <Link href="/frequencia-timemania">
                    <Button variant="outline" size="sm" className="w-full justify-start gap-2 text-xs">
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-5 shadow-sm">
                ...
                <p className="text-sm text-gray-600">
                  A Timemania é sorteada terças, quintas e sábados, às 20h. Os resultados são atualizados automaticamente após cada sorteio.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-5 shadow-sm">
                ...
                <Link href={`/${slug}`}>
                  <Button variant="outline" size="sm" className="w-full text-xs gap-1.5">
                    <ArrowRight className="w-3 h-3" />
                    Ver todos os concursos da Timemania
                  </Button>
                </Link>
              </div>
            </div>
        ...
        <div className="mt-8 bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="font-medium text-[#0d1b3e] text-sm">Que horas sai o resultado da Timemania?</h3>
              <p className="text-sm text-gray-600 mt-1">O sorteio da Timemania acontece terças, quintas e sábados, às 20h. Os resultados são publicados minutos após o sorteio.</p>
            </div>
            <div>
              <h3 className="font-medium text-[#0d1b3e] text-sm">Quantos números são sorteados na Timemania?</h3>
              <p className="text-sm text-gray-600 mt-1">São sorteados 7 números de um total de 01 a 80.</p>
            </div>
            <div>
              <h3 className="font-medium text-[#0d1b3e] text-sm">Quanto custa apostar na Timemania?</h3>
              <p className="text-sm text-gray-600 mt-1">A aposta mínima custa R$ 3,50. Quanto mais números marcar, maior o valor da aposta e as chances de ganhar.</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-wrap gap-2">
            <Link href="/numeros-mais-sorteados-timemania">
              <Button variant="outline" size="sm" className="text-xs gap-1.5 hover:bg-gray-50">
                <ArrowRight className="w-3 h-3" /> Números mais sorteados da Timemania
              </Button>
            </Link>
            <Link href="/numeros-atrasados-timemania">
              <Button variant="outline" size="sm" className="text-xs gap-1.5 hover:bg-gray-50">
                <ArrowRight className="w-3 h-3" /> Números atrasados da Timemania
              </Button>
            </Link>
            <Link href={`/gerador?loteria=${slug}`}>
              <Button variant="outline" size="sm" className="text-xs gap-1.5 hover:bg-gray-50">
                <ArrowRight className="w-3 h-3" /> Gerador da Timemania
              </Button>
            </Link>
          </div>
        </div>
