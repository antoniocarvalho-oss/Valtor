...
export default function ResultadoQuinaHoje() {
  const slug = "quina";
  ...
  const schema = {
    ...
    "@type": "WebPage",
    name: `Resultado da Quina Hoje — Valtor`,
    description: `Confira o último resultado da Quina. Números sorteados, prêmios e ganhadores atualizados.`,
    url: "https://www.valtor.com.br/resultado-quina-hoje",
  ...
  return (
    <div className="min-h-screen bg-[#f0f4f8]">
      <SEO
        title="Resultado da Quina Hoje — Último Concurso"
        description="Confira o resultado mais recente da Quina com números sorteados, prêmios e ganhadores. Atualizado após cada sorteio."
        path="/resultado-quina-hoje"
        schema={schema}
      />
      <Navbar />
      ...
      >
        <div className="container">
          ...
          <h1 className="text-2xl md:text-3xl font-black">Resultado da Quina hoje</h1>
          <p className="text-white/70 mt-1">
            Confira os números sorteados no último concurso da Quina
          </p>
        </div>
      </div>
      ...
      <div className="container py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-5">
              <div className="bg-white rounded-2xl border border-gray-200 p-5 shadow-sm">
                <h3 className="font-bold text-[#0d1b3e] text-sm mb-3">Análises da Quina</h3>
                <div className="space-y-2">
                  <Link href="/numeros-mais-sorteados-quina">
                    <Button variant="outline" size="sm" className="w-full justify-start gap-2 text-xs">
                      <TrendingUp className="w-4 h-4" style={{ color }} />
                      Números mais sorteados
                    </Button>
                  </Link>
                  <Link href="/numeros-atrasados-quina">
                    <Button variant="outline" size="sm" className="w-full justify-start gap-2 text-xs">
                      <TrendingDown className="w-4 h-4" style={{ color }} />
                      Números atrasados
                    </Button>
                  </Link>
                  <Link href="/frequencia-quina">
                    <Button variant="outline" size="sm" className="w-full justify-start gap-2 text-xs">
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-5 shadow-sm">
                ...
                <p className="text-sm text-gray-600">
                  A Quina é sorteada de segunda a sábado, às 20h. Os resultados são atualizados automaticamente após cada sorteio.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-5 shadow-sm">
                ...
                <Link href={`/${slug}`}>
                  <Button variant="outline" size="sm" className="w-full text-xs gap-1.5">
                    <ArrowRight className="w-3 h-3" />
                    Ver todos os concursos da Quina
                  </Button>
                </Link>
              </div>
            </div>
        ...
        <div className="mt-8 bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="font-medium text-[#0d1b3e] text-sm">Que horas sai o resultado da Quina?</h3>
              <p className="text-sm text-gray-600 mt-1">O sorteio da Quina acontece de segunda a sábado, às 20h. Os resultados são publicados minutos após o sorteio.</p>
            </div>
            <div>
              <h3 className="font-medium text-[#0d1b3e] text-sm">Quantos números são sorteados na Quina?</h3>
              <p className="text-sm text-gray-600 mt-1">São sorteados 5 números de um total de 01 a 80.</p>
            </div>
            <div>
              <h3 className="font-medium text-[#0d1b3e] text-sm">Quanto custa apostar na Quina?</h3>
          ...
          <div className="flex flex-wrap gap-2">
            <Link href="/numeros-mais-sorteados-quina">
              <Button variant="outline" size="sm" className="text-xs gap-1.5 hover:bg-gray-50">
                <ArrowRight className="w-3 h-3" /> Números mais sorteados da Quina
              </Button>
            </Link>
            <Link href="/numeros-atrasados-quina">
              <Button variant="outline" size="sm" className="text-xs gap-1.5 hover:bg-gray-50">
                <ArrowRight className="w-3 h-3" /> Números atrasados da Quina
              </Button>
            </Link>
            <Link href={`/gerador?loteria=${slug}`}>
              <Button variant="outline" size="sm" className="text-xs gap-1.5 hover:bg-gray-50">
                <ArrowRight className="w-3 h-3" /> Gerador da Quina
              </Button>
            </Link>
          </div>
        </div>
